import { Post, Get, Controller, Param, Body, Put, Delete } from '@nestjs/common';
...
export class AppOrdersController {
  ...
  async updateOrder(@Param('id') id: string) {
    return this.appOrderService.updateOrder(id);
  }

  @Delete('order/:id')
  async deleteOrder(@Param('id') id: string) {
    return this.appOrderService.cancelOrder(id);
  }
}
