...
import { MarzPayService } from './marz.service';

@Controller('api/transactions')
export class MarzController {
  constructor(private readonly transactionService: MarzPayService) {}
  ...
  marzCallback(@Body() data: any) {
    ...
    return this.transactionService.processCallback(data);
  }
  ...
  checkPaymentStatus(@Param() reference: { reference: string }) {
    ...
    return this.transactionService.checkTransactionStatus(reference.reference);
  }
